        ...
        <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-3">
          ...
          <Ripple color="rgba(255, 255, 255, 0.6)">
            <motion.a
              ...
              className="w-12 h-12 md:w-14 md:h-14 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-colors flex items-center justify-center group relative overflow-hidden"
          ...
          <Ripple color="rgba(255, 255, 255, 0.6)">
            <motion.a
              ...
              onClick={handleEmail}
              className="w-12 h-12 md:w-14 md:h-14 bg-primary-500 text-white rounded-full shadow-lg hover:bg-primary-600 transition-colors flex items-center justify-center group relative overflow-hidden"
          ...
          <Ripple color="rgba(255, 255, 255, 0.6)">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={scrollToTop}
              className="w-12 h-12 md:w-14 md:h-14 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 transition-colors flex items-center justify-center relative overflow-hidden"
