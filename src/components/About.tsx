          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-2 h-2 bg-primary-600 rounded-full mt-2" />
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1">Client-Centric Approach</h3>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600">We deliver robust, scalable, and maintainable solutions that stand the test of time.</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
